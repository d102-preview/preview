...
import { IResumeInfo } from '@/types/model';
...
const ResumeQuestions = ({ type, resumeList }: QuestionsProps) => {
  const [selectedResume, setSelectedResume] = useState<IResumeInfo | undefined>(resumeList[0]);
  ...
  const handleListItemClick = (resume: IResumeInfo) => {
