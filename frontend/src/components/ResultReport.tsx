...
const ResultReport = ({ question, name, percent, prepare }: ResultReportProps) => {
  return (
    <main className="w-10/12 mx-auto ">
      ...
      <div className="shadow-xl p-20 my-3 rounded-lg">
        <h3 className="text-3xl font-bold text-BLACK">총평</h3>
        <div className="p-3 text-[#696969] text-xl">
        ...
        <div className="flex items-center">
          ...
          <InterviewPrepared state={1} name={name} />
        </div>
      </div>
    </main>
  );
