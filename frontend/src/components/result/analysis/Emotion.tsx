    ...
    <div className="p-5 w-full">
      ...
      <div className="flex justify-evenly p-3 gap-5">
        <div>
          ...
          <p className="font-bold text-lg text-center text-BLACK">긍정</p>
          <p className="font-bold text-2xl text-center text-MAIN1">{ratio.positive ? ratio.positive : 0}%</p>
        </div>
        <div>
          <div className="w-full">
            <Lottie options={neutralOptions} />
          </div>
          <p className="font-bold text-lg text-center text-BLACK">중립</p>
          <p className="font-bold text-2xl text-center text-yellow-500">{ratio.neutral ? ratio.neutral : 0}%</p>
        </div>
        <div>
          <div className="w-full">
            <Lottie options={negativeOptions} />
          </div>
          <p className="font-bold text-lg text-center text-BLACK">부정</p>
          <p className="font-bold text-2xl text-center text-red-400">{ratio.negative ? ratio.negative : 0}%</p>
        </div>
      </div>
